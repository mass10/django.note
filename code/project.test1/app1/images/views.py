...
def thumbnails(request):
	...
	for e in _enum_files('/var/images'):
		parent, name = os.path.split(e)
		# name, ext = os.path.splitext(name)
		# logger.debug('parent=[' + parent + '], name=[' + name + '], ext=[' + ext + ']')
		names.append(name)
...
def thumbnail(request):
	...
	# process
	# =========================================================================
	image_id = request.META.get('QUERY_STRING')

	# =========================================================================
	# contents
	# =========================================================================
	stream = open(os.path.join('/var/images/', image_id), 'rb')
	image = stream.read()
	return django.http.HttpResponse(image, mimetype='image/jpg')
